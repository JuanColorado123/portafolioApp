...
public class PersonalInfoRepositoryImpl implements IPersonalInfoRepository{
    ...
    private final RowMapper<PersonalInfo> rowMapper = (rs,numRow) -> {
        ...
        personalInfo.setYearOfExperience(rs.getObject("years_of_experience",Integer.class));
    ...
    public PersonalInfo save(PersonalInfo personalInfo) {
        if(personalInfo.getId() == null){
            ...
            jdbcTemplate.update(con -> {
                ...
                ps.setInt   (6,personalInfo.getYearOfExperience());
            ...
            jdbcTemplate.update(sql,
                    ...
                    personalInfo.getYearOfExperience(),
